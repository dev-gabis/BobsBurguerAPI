...
const urlCharacters = "https://bobsburgers-api.herokuapp.com/episodes/"
...
const pintarCards = characters => {
    ...
    characters.forEach(element =>{
        ...
        templateCard.querySelector(".codproduccion").textContent = element.productionCode;
        templateCard.querySelector(".fecha-estreno").textContent = element.airDate;
        templateCard.querySelector(".temporada").textContent = element.season;
        templateCard.querySelector(".episodio").textContent = element.episode;
        templateCard.querySelector(".viewers").textContent = element.totalViewers;
